...
import categoryCtril from "./category.controller.js";
const categoryRouter = Router()

categoryRouter.post('/create',allowUsers(userRoles.ADMIN),uploader().single('image'),bodyValidator(categoryDTO),categoryCtril)
