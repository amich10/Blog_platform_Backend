...
categoryRouter.patch('/update-category:id',allowUsers(userRoles.ADMIN),uploader().single('image'),bodyValidator(updateCategoryDTO),categoryCtrl.updateCategoryById)
