...
import PostModel from '../post/post.model.js'; // Make sure you import the Post model
...
class commentControl {
    ...
    getTotalCommentCount = async (req, res, next) => {
        try {
            const postId = req.params.id; // We are assuming the `id` corresponds to the postId directly
