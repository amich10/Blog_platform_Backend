...
postRouter.patch('/update/:id',allowUsers(userRoles.ADMIN,userRoles.AUTHOR),uploader().single('image'),bodyValidator(),postCtrl.updatepostById)
postRouter.delete('/delete/:id',allowUsers(userRoles.ADMIN,userRoles),postCtrl.deleteCatgoryById)
