...
import { forgetPasswordDTO, userLoginDTO, userRegisterDTO } from "./auth.vallidator.js";
...
authRouter.patch('/password-reset/',bodyValidator(Rese),authCtrl.resetPassword)
